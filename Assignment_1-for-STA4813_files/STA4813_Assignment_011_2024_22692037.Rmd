---
title: "STA4813_Assignemet_01_2024"
...
Model_3<- lm(Machinery_T$Average_Purchase_Price~ Machinery_T$Tractor_Power + Machinery_T$Tractor_Types_dummy)
summary(Model_3)
coef(Model_3)
```
...
cat("Now the Estimated Regression Line Equation is given y =", round(intercept, 8), "+", round(slope, 8),"* x1\n",round(slope1, 8), "*x2\n")
```
...
R36835.91 when type of a tractor is "2 WD"
...
```{r}
Model_4<-lm(Machinery_T$Average_Purchase_Price ~ Machinery_T$Tractor_Power + Machinery_T$Tractor_Types_dummy_1_a + Machinery_T$Fuel_Usage, data = Machinery_T)
summary(Model_4)
```
